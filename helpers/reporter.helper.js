  ...
  return new Promise((resolve, reject) => {
    try {
      const flatR = {
        ...
        'activeTeam.teamLeader.createdAt': (r.activeTeam && r.activeTeam.teamLeader && r.activeTeam.teamLeader.createdAt) ? r.activeTeam.teamLeader.createdAt : null,
        'activeTeam.teamLeader.updatedAt': (r.activeTeam && r.activeTeam.teamLeader && r.activeTeam.teamLeader.updatedAt) ? r.activeTeam.teamLeader.updatedAt : null,
        ...
        'activeTeam.teamMember.createdAt': (r.activeTeam && r.activeTeam.teamMember && r.activeTeam.teamMember.createdAt) ? r.activeTeam.teamMember.createdAt : null,
        'activeTeam.teamMember.updatedAt': (r.activeTeam && r.activeTeam.teamMember && r.activeTeam.teamMember.updatedAt) ? r.activeTeam.teamMember.updatedAt : null,
